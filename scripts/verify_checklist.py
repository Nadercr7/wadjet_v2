...
check("Φ-10", ".loader-wadjet-full in input.css", has(css, ".loader-wadjet-full"))
check("Φ-10", "Full-page loader in base.html", has(base, "loader-wadjet-full"))
check("Φ-10", "Loader fades out on alpine:initialized", has(base, "alpine:initialized"))
check("Φ-10", "Stories loading: branded loader", has(stories, "loader-wadjet") or has(stories, "brand-mark"))
check("Φ-10", "Story reader loading: branded loader", has(story_reader, "loader-wadjet") or has(story_reader, "brand-mark"))
manual_check("Φ-10", "Dictionary loading: branded loader")
manual_check("Φ-10", "Explore loading: branded loader")
